...
def graph():
  ...
  pygame.draw.lines(window,(0,0,0),False,[(0,250),(500,250)],2)
  pygame.draw.lines(window,(0,0,0),False,[(250,0),(250,500)],2)
  pygame.draw.lines(window,(0,0,0),False,[(123,123),(123,123)],2)
  pygame.draw.lines(window,(0,0,0),False,[(123,123),(123,123)],2)
